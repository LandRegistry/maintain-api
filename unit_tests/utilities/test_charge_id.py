...
from maintain_api.constants.charge_id import ChargeId
from maintain_api.exceptions import ApplicationError
from maintain_api.utilities.charge_id \
...
class TestChargeIdService(TestCase):
    ...
    @patch('maintain_api.utilities.charge_id.encode_base_31')
    @patch('maintain_api.utilities.charge_id.add_prefix')
    ...
    @patch('maintain_api.utilities.charge_id.decode_base_31')
    @patch('maintain_api.utilities.charge_id.remove_prefix')
